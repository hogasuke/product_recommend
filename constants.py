...
# 在庫状況表示用のアイコン
STOCK_ICON_WARNING = "⚠️"
STOCK_ICON_ERROR = "❌"
STOCK_ICON_SUCCESS = "✅"

# 在庫状況表示用のメッセージ
STOCK_MESSAGE_LOW = "ご好評につき、在庫数が残りわずかです。購入をご希望の場合、お早めの注文をおすすめいたします。"
STOCK_MESSAGE_OUT = "申し訳ございませんが、本商品は在庫切れとなっております。入荷までもうしばらくお待ちください。"
STOCK_MESSAGE_AVAILABLE = "在庫あり"
